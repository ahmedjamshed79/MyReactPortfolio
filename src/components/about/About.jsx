      ...
      <div className="container">
        <div className="left">
          <p>
            ...
            interactive web applications using client-side development
            technologies, while following the best modern practices and
            methodologies like agile kanban and conducting proactive risk
